...
Sans aucune défaillance, il n'y a pas de cas critique, est on observe qu'effectivement, qu'il 
...
De la même façon on a également un grand nombre de coup gagnant (142 sur 220 possible).
L'optimisation fonctionne donc très bien et nous propose un controleur bien plus efficace que le précédent.
